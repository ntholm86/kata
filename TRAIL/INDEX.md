...
*Last rebuilt: 2026-04-20T12:15:19+02:00*
...
Alternatives: *not recorded*
### DEC-034: Make target-repo routing explicit in the global VS Code instruction, `kata/SK...
...
### DEC-035: Migrate the skills suite's live run ledger from repo root `GENBA.md` to `TRAI...
...
### DEC-036: Update `verify-suite.ps1` and `metrics.ps1` to use `TRAIL/GENBA.md` as the li...
...
### DEC-037: Move GENBA.md ownership from kiroku to Kata
...
### DEC-038: Make all measurements context-derived, not universal
...
### DEC-039: Agent inherits prior run's measurement scheme by default
...
Alternatives: *not recorded*
### DEC-040: ` matching to line start (`^\s*\[!DECISION\]`) in both kiroku-index.ps1 and k...
