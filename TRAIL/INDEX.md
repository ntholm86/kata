...
*Last rebuilt: 2026-04-20T11:49:24+02:00*
...
### DEC-032: Make target-repo routing explicit in the global VS Code instruction, `kata/SK...
...
### DEC-033: Migrate the skills suite's live run ledger from repo root `GENBA.md` to `TRAI...
...
### DEC-034: Update `verify-suite.ps1` and `metrics.ps1` to use `TRAIL/GENBA.md` as the li...
...
### DEC-035: Move GENBA.md ownership from kiroku to Kata
...
### DEC-036: Make all measurements context-derived, not universal
...
### DEC-037: Agent inherits prior run's measurement scheme by default
...
Alternatives: *not recorded*
### DEC-038: ` matching to line start (`^\s*\[!DECISION\]`) in both kiroku-index.ps1 and k...
