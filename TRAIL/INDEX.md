...
*Last rebuilt: 2026-04-20T17:17:21+02:00*
...
### DEC-029: Add root README.md and archive 7 journey documents to v1_archive/
...
### DEC-030: Fix all 4 consistency gaps as Kaizen — no structural change needed
...
### DEC-031: Measurement scheme for this target (TPS Skill Suite):
...
### DEC-032: Methodology: Kaizen. Structure is sound. Two specific bugs need fixing.
...
### DEC-033: Score: 7.625 → 7.875 (v3), delta +0.25.
...
Alternatives: *not recorded*
### DEC-034: Defer finding-overlap infrastructure (Finding 5).
...
### DEC-035: Methodology: Kaizen focused on weak dims 3, 5, 7.
...
Alternatives: *not recorded*
### DEC-036: Execute Hansei's recommendation as a scored GPT-5.4 Kata -> Kaizen run rather...
...
### DEC-037: Move 'Historical Snapshot' and Rubric v1/v2 defs out of SCORECARD.md into 1_...
...
### DEC-038: Leave D8 (ARF) at 9 and mark the post-rebuild Shiken recommendation from Run ...
...
Alternatives: *not recorded*
### DEC-039: Make target-repo routing explicit in the global VS Code instruction, `kata/SK...
...
### DEC-040: Migrate the skills suite's live run ledger from repo root `GENBA.md` to `TRAI...
...
### DEC-041: Update `verify-suite.ps1` and `metrics.ps1` to use `TRAIL/GENBA.md` as the li...
...
### DEC-042: Start Kiroku immediately once the lapse was noticed and record the late start...
...
### DEC-043: Explain the 3M change as an intentional redesign choice, not as accidental de...
...
### DEC-044: Fix `verify-suite.ps1` Check 5 at the inclusion-rule level instead of editing...
...
### DEC-045: Record the residual Kiroku warning honestly rather than retroactively inventi...
...
### DEC-046: Tighten `kiroku-validate.ps1` Check 7 to count only actual rationale/alternat...
...
### DEC-047: Move GENBA.md ownership from kiroku to Kata
...
### DEC-048: Make all measurements context-derived, not universal
...
### DEC-049: Agent inherits prior run's measurement scheme by default
...
Alternatives: *not recorded*
### DEC-050: ` matching to line start (`^\s*\[!DECISION\]`) in both kiroku-index.ps1 and k...
